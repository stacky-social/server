...
class FollowService < BaseService
  ...
  def request_follow!
    ...
    if @target_account.local?
      ...
      ActivityPub::DeliveryWorker.perform_async(build_json(follow_request), @source_account.id, @target_account.inbox_url, { 'bypass_availability' => true }) unless @target_account.internal?
    end
