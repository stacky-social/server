...
class ActivityPub::Activity::Create < ActivityPub::Activity
  ...
  def create_status
    return reject_payload! if unsupported_object_type? || (!@account.internal? && @json[:ext_flag].nil? && non_matching_uri_hosts?(@account.uri, object_uri)) || tombstone_exists? || !related_to_local_activity?
